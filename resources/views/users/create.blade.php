        ...
        <div class="box-body">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="form-group {{ $errors->has('name')?'has-error':'' }}">
                    ...
                    <input type="text" name="name" class="form-control" id="name" placeholder="{{ trans('form.field.name') }}" value="{{ old('name')?:$user?$user->user_name:'' }}">
                    @if ($errors->has('name'))
                ...
                <div class="form-group {{ $errors->has('username')?'has-error':'' }}">
                    ...
                    <input type="text" name="username" class="form-control" id="username" placeholder="{{ trans('form.field.username') }}" value="{{ old('username')?:$user?$user->user_login:'' }}">
                ...
                <div class="form-group {{ $errors->has('phone')?'has-error':'' }}">
                    ...
                    <input type="text" name="phone" class="form-control" id="phone" placeholder="{{ trans('form.field.phone') }}" value="{{ old('phone')?:$user?$user->user_phone:'' }}">
                    @if ($errors->has('phone'))
                ...
                <div class="form-group {{ $errors->has('email')?'has-error':'' }}">
                    ...
                    <input type="email" name="email" class="form-control" id="email" placeholder="{{ trans('form.field.email') }}" value="{{ old('email')?:$user?$user->user_email:'' }}">
                    @if ($errors->has('email'))
                ...
                <div class="form-group {{ $errors->has('address')?'has-error':'' }}">
                    ...
                    <input type="text" name="address" class="form-control" id="address" placeholder="{{ trans('form.field.address') }}" value="{{ old('address')?:$user?$user->user_address:'' }}">
                ...
                <div class="form-group {{ $errors->has('postal_code')?'has-error':'' }}">
                    ...
                    <input type="text" name="postal_code" class="form-control" id="zip" placeholder="{{ trans('form.field.zip') }}" value="{{ old('zip')?:$user?$user->user_zip:'' }}">
                ...
                <div class="form-group {{ $errors->has('city')?'has-error':'' }}">
                    ...
                    <input type="text" name="city" class="form-control" id="city" placeholder="{{ trans('form.field.city') }}" value="{{ old('city')?:$user?$user->user_city:'' }}">
                    @if ($errors->has('city'))
                ...
                <div class="form-group {{ $errors->has('state')?'has-error':'' }}">
                    ...
                    <input type="text" name="state" class="form-control" id="state" placeholder="{{ trans('form.field.state') }}" value="{{ old('state')?:$user?$user->user_state:'' }}">
                    @if ($errors->has('state'))
                ...
                <div class="form-group {{ $errors->has('country')?'has-error':'' }}">
                    ...
                    <input type="text" name="country" class="form-control" id="country" placeholder="{{ trans('form.field.country') }}" value="{{ old('country')?:$user?$user->user_country:'' }}">
